                ...
                <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                        ...
                        <p className="mt-10 text-left text-xs opacity-60">
                            By signing in, you agree to our <span className='hover:underline text-[#007bff] cursor-pointer'>Terms of Service</span> and <span className="hover:underline text-[#007bff] cursor-pointer">Privacy Policy</span>.
                        </p>
                    </div>
                </div>
            </div>
