      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-12 absolute left-3 md:left-3 w-12 rounded-full bg-white dark:bg-black flex items-center justify-center">
              ...
              <h3 className="hidden md:block text-2xl md:pl-24 md:text-6xl font-bold text-neutral-500 dark:text-neutral-500">
                {item.title}
              </h3>
            </div>

            <div className="relative pl-24 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-3xl mb-6 text-left font-bold text-neutral-500 dark:text-neutral-500">
                {item.title}
              </h3>
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[3px] bg-gradient-to-t from-purple-500 via-[#007FFF] to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
